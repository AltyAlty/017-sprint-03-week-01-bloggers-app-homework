...
import { GetCommentListInPostQueryInputDTO } from '../../../comments/routes/input-dto/get-comment-list-in-post-query.input-dto';
...
/*Функция-обработчик "getCommentListByPostIdHandler()" для GET-запросов по получению комментариев с пагинацией в посте
по ID, используя URI-параметры.*/
export const getCommentListByPostIdHandler = async (
  req: Request<{ postId: string }, {}, {}, GetCommentListInPostQueryInputDTO>,
  ...
  try {
    ...
    const sanitizedQueryInputWithDefaultPaginationSettings = getSanitizedQueryInputWithDefaultPaginationSettings<
      GetCommentListInPostQueryInputDTO,
