...
import { GetPostListQueryInputDTO } from '../input-dto/get-post-list-query.input-dto';
...
/*Функция-обработчик "getPostListHandler()" для GET-запросов по получению постов с пагинацией, используя
query-параметры.*/
